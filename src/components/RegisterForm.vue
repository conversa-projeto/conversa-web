<template>
  <div class="mx-auto mt-10 w-full max-w-md overflow-hidden rounded-2xl border border-surface-300 bg-surface-base shadow-xl">
    <div class="bg-surface-50 px-6 py-8 text-center">
      <img src="/logo.png" alt="Logo" class="mx-auto h-[200px] w-[200px]" />
      <h1 class="mt-4 text-2xl font-bold text-surface-800">Conversa</h1>
      <p class="mt-1 text-sm text-surface-600">Crie sua conta</p>
    </div>
