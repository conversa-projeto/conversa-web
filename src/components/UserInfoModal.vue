    ...
    <div class="relative w-full max-w-[260px] rounded-3xl bg-surface-base shadow-2xl">
      ...
      <div class="px-5 pb-5">
        ...
        <button
          v-if="conversaId"
          type="button"
          class="mt-3 flex w-full items-center justify-center gap-2 rounded-xl bg-primary-600 px-4 py-2.5 text-sm font-medium text-white transition hover:bg-primary-700"
          @click="emit('open-anexos', conversaId)"
        >
...
const props = defineProps<{
  ...
  /** Quando presente, habilita o botao "Ver anexos" que navega para /anexos/:conversaId */
